...
namespace GameTrackerMAUI.ViewModels
{
    ...
    public class PlatformDetailViewModel : BaseViewModel
    {
        ...
        async void OnDelete()
        {
            Tuple<PopupMain.EnumOutputType, string> ret = (Tuple<PopupMain.EnumOutputType, string>)await ShowPopupAsync(new PopupMain("Attention", "Are you sure you would like to delete this platform?", PopupMain.EnumInputType.YesNo));
